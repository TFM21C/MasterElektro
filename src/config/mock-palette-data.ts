...
export const MOCK_PALETTE_COMPONENTS: PaletteComponentFirebaseData[] = [
  ...
  },
  {
    ...
    defaultLabelPrefix: 'L1',
    category: 'Energieversorgung',
    description: 'Einzelne Stromleitung L1.',
    hasToggleState: false,
    hasEditablePins: false,
    initialPinLabels: { 'out': '' },
    resizable: true,
  ...
  },
  {
    ...
    defaultLabelPrefix: 'L2',
    category: 'Energieversorgung',
    description: 'Einzelne Stromleitung L2.',
    hasToggleState: false,
    hasEditablePins: false,
    initialPinLabels: { 'out': '' },
    resizable: true,
  ...
  },
  {
    ...
    defaultLabelPrefix: 'L3',
    category: 'Energieversorgung',
    description: 'Einzelne Stromleitung L3.',
    hasToggleState: false,
    hasEditablePins: false,
    initialPinLabels: { 'out': '' },
    resizable: true,
  ...
  },
  {
    ...
    defaultLabelPrefix: 'N',
    category: 'Energieversorgung',
    description: 'Einzelne Neutralleiter-Leitung.',
    hasToggleState: false,
    hasEditablePins: false,
    initialPinLabels: { 'out': '' },
    resizable: true,
  ...
  },
  {
    ...
    defaultLabelPrefix: 'PE',
    category: 'Energieversorgung',
    description: 'Einzelne Schutzleiter-Leitung.',
    hasToggleState: false,
    hasEditablePins: false,
    initialPinLabels: { 'out': '' },
    resizable: true,
  ...
  },
  {
    ...
    initialPinLabels: { 'L': 'L', 'Out': 'Out' },
    resizable: true,
    defaultSize: { width: COMPONENT_DEFINITIONS['Ausschalter']?.width || 60, height: COMPONENT_DEFINITIONS['Ausschalter']?.height || 60 },
    minScale: 0.8, maxScale: 1.5, scaleStep: 0.1,
    simulation: {
      interactable: true,
      controlLogic: 'toggle_on_click',
